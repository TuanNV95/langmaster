      ...
      <article className="page site-page">
        ...
        <div className="page__inner">
          ...
          <p className="page__description top">
            {'This website is built on open source version 7 of Yui540\'s portfolio page yui540.'}<br /> Below is the information of the original version written by the author.<br />
