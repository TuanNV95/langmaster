    ...
    return (
      <article className="page product-page">
        ...
        <div className="page__inner">
          ...
          <h2 className="page__sub-title top">Do daily challenges<br /> Quantity may be less than actual!</h2>
          ...
          {/* <h2 className="page__sub-title">Page 2</h2>
          <section className="product-page__content">
          ...
          <h2 className="page__sub-title">Page 3</h2>
          <section className="product-page__content">
